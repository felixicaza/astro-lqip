...
This way, Astro can automatically manage and optimize your images, improving your website’s performance. Furthermore, by using the `<Image>` or `<Picture>` components from [astro-lqip](https://npmx.dev/package/astro-lqip), you can take advantage of additional features such as generating [low-quality placeholders](/#:~:text=Props) versions for a better user experience.
